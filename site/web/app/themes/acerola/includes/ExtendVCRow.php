    ...
    public function row_init(){
        if( function_exists('vc_add_param') ){
            ...
            vc_add_param('vc_row', array(
                "type" => "dropdown",
                "heading" => esc_html__("Overlay", "themeton"),
                "param_name" => "vc_row_overlay",
                "value" => array(
                        esc_html__("No", "themeton") => "no",
                        esc_html__("Yes", "themeton") => "yes",
                    )
            ));

            vc_add_param('vc_row', array(
                "type" => "colorpicker",
                "heading" => esc_html__("Overlay Color", "themeton"),
            ...
            vc_add_param('vc_row', array(
                "type"      => "textfield",
                "heading"   => esc_html__("Overlay Opacity", "themeton"),
            ...
            */
            ...
            vc_add_param('vc_row', array(
                "type" => "dropdown",
                "heading" => esc_html__("One Page Section", 'acerola'),
                "param_name" => "one_page_section",
                "value" => array(
                        esc_html__("No", 'acerola') => "no",
                        esc_html__("Yes", 'acerola') => "yes",
                    )
            ));

            vc_add_param('vc_row', array(
                "type" => "textfield",
                "heading" => esc_html__("Section Label", 'acerola'),
            ...
            vc_add_param('vc_row', array(
                "type" => "textfield",
                "heading" => esc_html__("Section slug", 'acerola'),
                "description" => esc_html__("Don't need hash tag (#). You can apply a custom link to redirect.", 'acerola'),
            ...
            vc_add_param('vc_column', array(
                "type" => "dropdown",
                "heading" => esc_html__("Horizontal Alignment", 'acerola'),
                "param_name" => "horizontal_align",
                "value" => array(
                        esc_html__("None", 'acerola') => "none",
                        esc_html__("Left", 'acerola') => "left",
                        esc_html__("Center", 'acerola') => "center",
                        esc_html__("Right", 'acerola') => "right"
                    )
            ));
            vc_add_param('vc_column', array(
                "type" => "dropdown",
                "heading" => esc_html__("Vertical Alignment", 'acerola'),
                "param_name" => "vertical_align",
                "value" => array(
                        esc_html__("None", 'acerola') => "none",
                        esc_html__("Top", 'acerola') => "top",
                        esc_html__("Middle", 'acerola') => "middle",
                        esc_html__("Bottom", 'acerola') => "bottom"
                    )
            ));
