...
class tt_AddressWidget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'widget_address', 'description' => 'Recent posts.');
    ...
    function widget($args, $instance) {
        ...
        extract(array_merge(array(
                    'title' => 'Contact Info',
                    'address' => 'Architectura Worldwide Foundation 125/68 North 38th Str, Melbourne, VIC.',
                    'phone' => '(305) 533-1122',
                    'email' => 'info@architectura.com',
                    'site' => 'http://architecturahqs.com',
                        ), $instance));
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e("Title:", 'acerola'); ?></label>
            <input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($title); ?>"  />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e("address:", 'acerola'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e("phone:", 'acerola'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e("email:", 'acerola'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('site')); ?>"><?php esc_html_e("website:", 'acerola'); ?></label>
