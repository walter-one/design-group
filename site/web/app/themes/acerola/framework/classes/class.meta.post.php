...
class ThemetonMetaPost extends TTRenderMeta{
    ...
    public function post_images_box() {
                    ...
                    if ( $attachments )
                        foreach ( $attachments as $attachment_id ) {
                            echo '<li class="image" data-attachment_id="' . $attachment_id . '">
                                ...
                                <ul class="actions">
                                    <li><a href="#" class="delete" title="' . esc_html__( 'Delete image', 'acerola' ) . '">' . esc_html__( 'Delete', 'acerola' ) . '</a></li>
                                </ul>
                            </li>';
                        }
                ?>
        ...
        <p class="add_post_images hide-if-no-js">
            <a href="#"><?php esc_html_e( 'Add post gallery images', 'acerola' ); ?></a>
        </p>
        <?php
    }
    ...
    public function post_meta_boxes(){
        global $post;
        add_meta_box( 'post-images', esc_html__( 'Post Gallery', 'acerola' ), array($this, 'post_images_box'), 'post', 'side' );
    }
...
//new ThemetonMetaPost();/new ThemetonMetaPost();