    ...
    public static function getField($params){
        ...
        switch ($type) {
            ...
            case 'onepage':
                ...
                $html .= '<option value="0">' . esc_html__('Choose page...', 'acerola') . '</option>';
                $pages = get_pages();
            ...
            case 'checkbox':
                ...
                break;
            case 'customlink':
                return '<input type="text" ' . $gatts . ' value="' . esc_html($value) . '" /><input type="checkbox" value="1"/> Open in a new tab?';
                break;
            case 'video':
