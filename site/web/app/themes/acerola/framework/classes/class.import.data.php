...
class TT_ImportData{
        ...
        echo '<div class="wrap"><div id="icon-tools" class="icon32"></div>';
            ...
            echo '<form method="post">
                ...
                <tr>
                    ...
                    <td>
                        <label>
                        <input type="checkbox" name="download_attachment" value="1" /> Download image and data attachments. (Only for test usage!)
                        </label>
                    </td>
                </tr>
                <tr>
    ...
    public function import_data($param){
        ...
        if( !class_exists('WP_Import') )
            require_once( dirname(__FILE__)."/lib/wp.importer/wp.importer.php" );
