...
class WPSEO_Options_Extend {
    ...
    public static function get_all() {
        ...
        $all_options['breadcrumbs-404crumb']      = esc_html__( 'Error 404: Page not found', 'acerola' );
        $all_options['breadcrumbs-archiveprefix'] = esc_html__( 'Archives for', 'acerola' );
        $all_options['breadcrumbs-home']          = esc_html__( 'Home', 'acerola' );
        $all_options['breadcrumbs-searchprefix']  = esc_html__( 'You searched for', 'acerola' );
